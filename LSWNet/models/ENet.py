...
def net(num_class=20, input_height=256, input_width=256):
    ...
    # enet = (Reshape((outputHeight*outputWidth, num_class)))(enet)
    # enet = Activation('softmax')(enet)
    out = Conv2D(num_class, 1, activation='softmax')(enet)
