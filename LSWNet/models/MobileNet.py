...
def net (input_size=(IMAGE_SIZE, IMAGE_SIZE, 3), num_class=20):
    ...
    o = (Conv2D(num_class, (1, 1)))(o)
    # W = (N - 1) * S - 2P + F = 6 * 2 - 0 + 2 = 14
    o = Conv2DTranspose(num_class, kernel_size=(2, 2), strides=(2, 2), padding="valid")(o)
    # 14 x 14

    o2 = f4
    o2 = (Conv2D(num_class, (1, 1)))(o2)
    ...
    o = Conv2DTranspose(num_class , kernel_size=(8,8),  strides=(8,8), padding="valid", activation='softmax')(o)

    # o = Conv2D(num_jilclass, 1, activation='softmax')(o)
